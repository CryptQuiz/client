      ...
      <div className="mt-3 mb-12 flex justify-between">
        ...
        <div className='flex-grow mt-8 mx-8'>
          <div className='flex flex-row w-full justify-between'>
            <div className='w-3/5 px-5 py-auto text-center bg-neu-orange text-black text-32 font-bold rounded-20 border border-black border-r-8 border-b-8'>Truefeedback Quiz Yarışması</div>
